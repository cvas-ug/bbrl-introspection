...
writer = SummaryWriter("experiments/original_choreographer_noise/test_noise_10")
behaviour_net = BehaviourNetwork("weights")
choreographer = ChoreographNetwork("weights")
if args.use_cuda:
    behaviour_net.cuda()
    choreographer.cuda()
...
torch.save(acts_dict, "data/v5_dataset/acts.pt")
